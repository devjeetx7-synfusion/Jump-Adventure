...
object WorldRepository {
    ...
    private val themeTemplates = listOf(
        ...
        Triple("Jungle", "🌴", Pair("#2E7D32", "#A5D6A7")),
        Triple("Ocean World", "🌊", Pair("#0288D1", "#00ACC1")),
        Triple("Sky Islands", "☁️", Pair("#E1F5FE", "#90CAF9")),
        Triple("Ancient Ruins", "🏛️", Pair("#3E2723", "#8D6E63")),
        Triple("Crystal Cave", "💎", Pair("#0F172A", "#00E5FF")),
        Triple("Dark Forest", "🌲", Pair("#0B1426", "#2E7D32")),
        Triple("Volcano", "🌋", Pair("#260F17", "#FF3D00")),
        Triple("Cyber World", "🤖", Pair("#1A0F2E", "#00E676")),
    ...
    val worlds: List<WorldInfo>
        get() = (1..50).map { getWorldForLevel((it - 1) * 25 + 1) }
